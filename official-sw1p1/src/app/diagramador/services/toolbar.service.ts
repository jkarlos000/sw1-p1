  ...
  getToolbarConfig() {
    return {
      groups: {
        ...
        xmlImportar: { index: 6 },
        xmlExportar: { index: 7 },
        jsonImportar: { index: 8 },
        jsonExportar: { index: 9 },
        flutterExportar: { index: 10 },
        importar: { index: 11 },
        fullscreen: { index: 12 },
        order: { index: 13 },
        layout: { index: 14 },
      ...
      tools: [
        ...
        {
          type: 'button',
          name: 'flutterExportar',
          group: 'flutterExportar',
          text: 'Export Flutter',
          attrs: {
            button: {
              id: 'btn-export-flutter',
              'data-tooltip': 'Export project as Flutter app',
              'data-tooltip-position': 'top',
              'data-tooltip-position-selector': '.toolbar-container',
            },
          },
        ...
        },
        {
          ...
          attrs: {
            button: {
              id: 'btn-exportar-sql',
              'data-tooltip': 'Generar Schema PostgreSQL con IA',
              'data-tooltip-position': 'top',
              'data-tooltip-position-selector': '.toolbar-container',
            },
          },
